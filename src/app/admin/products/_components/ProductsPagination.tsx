...
export default function ProductsPagination({
  ...
  const prevHref = hasPrev
    ? productsAdminHref({ ...filters, page: currentPage - 1 })
    : null;
  ...
  const rangeStart =
    totalCount === 0 ? 0 : (currentPage - 1) * PRODUCTS_PAGE_SIZE + 1;
  const rangeEnd = Math.min(currentPage * PRODUCTS_PAGE_SIZE, totalCount);
