        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <label
              htmlFor="brand-logo"
              className={cn(
                'flex min-h-[140px] cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-border bg-muted/40 p-6 text-center transition-colors',
            ...
            >
              {displayPreview ? (
                <div className="relative overflow-hidden rounded-lg border border-border/60 bg-muted p-3 shadow-inner">
                  <img
                    src={displayPreview}
